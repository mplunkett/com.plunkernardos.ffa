<%@ Page Title="" Language="C#" MasterPageFile="~/V2/Main2.master" AutoEventWireup="true" CodeFile="AuctionHouse2.aspx.cs" Inherits="V2_AuctionHouse2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="pagejs" Runat="Server">
    <script type="text/javascript">
        ...
        function OfferRefresh() {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/OfferRefresh",
                data: dataString,
        ...
        function BidRefresh() {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/BidRefresh",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function StatRefresh() {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/StatRefresh",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function PlaceBid(amt) {            
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/PlaceBid",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function PlaceOffer(amt,player) {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/PlaceOffer",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function OfferModPlayerLoad() {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/OfferModListLoad",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function OfferModPlayerSelect(playerId, positionId) {
            ...
            $.ajax({
                type: "POST",
                url: "AuctionHouse2.aspx/OfferModPlayerSelect",
                data: dataString,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 masonry">
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="OfferBidDiv">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form">
